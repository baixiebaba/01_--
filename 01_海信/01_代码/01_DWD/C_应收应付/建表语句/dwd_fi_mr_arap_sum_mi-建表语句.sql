...
CREATE TABLE IF NOT EXISTS test.dwd_fi_mr_arap_sum_mi (
    ...
    , ledger_status VARCHAR(50) COMMENT '台账状态'
    , acct_cert_type VARCHAR(20) COMMENT '凭证类型'
    , tax_rate DECIMALV3(27, 9) COMMENT '税率'
    , nature_l1_name VARCHAR(100) COMMENT '一级性质名称'
    , nature_l2_name VARCHAR(100) COMMENT '二级性质名称'
    , nature_l3_name VARCHAR(100) COMMENT '三级性质名称'
